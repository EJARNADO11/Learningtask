...
<html>
    <head>
	  ...
	  <link rel="preconnect" href="https://fonts.googleapis.com">
      <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
      <link href="https://fonts.googleapis.com/css2?family=Send+Flowers&family=Shadows+Into+Light&display=swap" rel="stylesheet">
    </head>
	
	<body>
	    <p class="font-one"> April is the cruellest month, breeding
		...
		<p class="font-two"> Summer surprised us, coming over the Starnbergersee
                             With a shower of rain; we stopped in the colonnade,
                             And went on in sunlight, into the Hofgarten,
                             And drank coffee, and talked for an hour. </p>
		<p class="font-three">Bin gar keine Russin, stamm’ aus Litauen, echt deutsch.
